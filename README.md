...
1. Исправить отображение на дисплее данных температуры и влажности с точкой.
1. Сделать пересчет уровня газа в проценты по формуле.
1. Добавить точку на дисплей в случае успешной отправки данных по газу на сервер согласно схеме дисплея.
2. Заменить RGB диод в корпусе OLED дисплея.
3. Сделать отдельные корпуса для датчиков газа и температуры с разъемами.
4. Заменить датчик температуры на DHT22.
5. Сделать корпус датчика движения наклонным для лучшего детектирования движения.
