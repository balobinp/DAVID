...
11. Сделать пользователя david. Настроить виртуальное окружение и перенести все скрипты в папку пользователя с виртуальным окружением.
...
16. Проверить в модуле climate_check.py настройку проверки пустых данных для предотвращения вылетания программы.
...
5. Обновить файл climate_check.py и поместить его в /home/user/david
5. Обновить прошивку NodeMcu01BedRoom.
6. Запустить скрин для david_web_server.py и climate_check.py
...
На примере программы climate_check.py:
...
3. Для каждого типа сообщений придумать сообщения по уровням
