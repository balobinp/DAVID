...
Описание:
Пятидневная скользящая средняя для сглаживания выбросов.
Пороги нормальных значений.
Поступает новое значение. Если оно в процентном отношении больше вчерашнего или в процентном отношении больше значения пятидневной давности по скользящей средней и выходит за границы нормальных значений, то идет информирование во WA.
Если более двух дней отсутсвют данные, или нет данных в рабочий день, то идет оповещение во WA.
Функцию оповещения сделать автономной, чтобы можно было легко заменить оповещение WA на голосовое или любое другое.
Метод запуска:
crontab
Задача:
...
------------------------------------
Микроконтроллер NodeMcu04Entrance
------------------------------------
Файл: 
