...
------------------------------------------------------------------------
Принцип формирования ToDo листа
------------------------------------------------------------------------
...
Файлы PCB и корпусов имеют название в Camel формате типа <Тип_контроллера><ID_контроллера><Комментарий>VerYYMMDD
На платах и корпусах печатать отдельно название и версию. Версию указывать через точку.
Например:
<Тип_контроллера><ID_контроллера><Комментарий> Ver.YYMMDD
